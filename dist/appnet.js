...
'use strict';
	...
	"parameter_category": {
		...
		"message_ids": [ "ids" ],
		"file_ids":		[ "ids" ],
		"message_search":	[ "index", "order", "query", "text", "channel_ids", "hashtags", "links",
								 "link_domains", "mentions", "leading_mentions",
								 "annotation_types", "attachment_types","place_id", "is_reply", "is_directed",
								 "has_location", "has_checkin", "has_attachment", "has_oembed_photo", "has_oembed_video",
								 "has_oembed_html5video", "has_oembed_rich", "language",
								 "client_id", "creator_id", "reply_to", "thread_id" ]
	},
	...
	"endpoints": [
		...
		},
		{
			...
			"data_params": [],
			"array_params": [],
			"get_params": [ "message_search", "general_message" ],
			"method": "GET",
			"url": [
			...
			"link": "https://developers.app.net/reference/resources/message/search/#search-for-messages"
		},
		{
			"group": "channel",
